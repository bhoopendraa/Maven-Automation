...
public class DMS_SSO_Ordering {

	private WebDriver driver;
	public DMS_SSO_Ordering(WebDriver driver) {
		this.driver = driver;
	...
	public DMS_SSO_Ordering clickpartsordermenu() {
		partsordermenu.click();
		return this;
		}
	
	//Method to Type password
	public DMS_SSO_Ordering clickdmsfiletrasfer() {
		dmsfiletrasfer.click();
		return this;
		}
	
	public DMS_SSO_Ordering clickpartsOrderDTOfileupload() {
		partsOrderDTOfileupload.click();
		return this;
		}
	public DMS_SSO_Ordering clicrevieworder() {
		revieworder.click();
		return this;
		}
	public DMS_SSO_Ordering Selectdealer(String sOption) {
		Select _sel = new Select(selectdealer);
		_sel.selectByVisibleText(sOption);
		return this;
		}
	public DMS_SSO_Ordering clicorderbutton() {
		orderbutton.click();
		return this;
		}
